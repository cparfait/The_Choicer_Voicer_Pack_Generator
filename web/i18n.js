...
const DICT = {
  ...
  'Il redemarre peut-etre : laisse-lui un instant, puis reessaie.':
    ['It may be restarting: give it a moment, then try again.',
      'Puede que se este reiniciando: dale un momento y vuelve a intentarlo.'],
  'Reessayer': ['Try again', 'Reintentar'],
  ...
  /* -- personnages, locuteurs, ambiance -------------------------------------- */
  'Depuis une video': ['From a video', 'Desde un video'],
  'Prendre une image dans une video': ['Take a still from a video', 'Tomar una imagen de un video'],
  'Detourer': ['Cut out', 'Recortar'],
  'Detourage...': ['Cutting out...', 'Recortando...'],
  'Enlever le fond et poser le personnage sur le sol':
    ['Remove the background and stand the character on the floor',
      'Quitar el fondo y apoyar al personaje en el suelo'],
  'Revenir a l\'image d\'origine': ['Back to the original image', 'Volver a la imagen original'],
  'Personnage detoure.': ['Character cut out.', 'Personaje recortado.'],
  'Image d\'origine retablie.': ['Original image restored.', 'Imagen original restaurada.'],
  'Image extraite de la video.': ['Still taken from the video.', 'Imagen extraida del video.'],
  'Joindre une image a chaque clip (les packs Dub de la communaute n\'y mettent souvent que des portraits de personnages)':
    ['Attach an image to every clip (community Dub packs usually ship only character portraits)',
      'Adjuntar una imagen a cada clip (los packs Dub de la comunidad suelen incluir solo retratos de personajes)'],
  'La video ne s\'affiche pas pendant l\'enregistrement : le jeu la joue a la fin de la manche, doublee avec tes prises.':
    ['The video does not play while you record: the game plays it at the end of the round, dubbed with your takes.',
      'El video no se ve mientras grabas: el juego lo reproduce al final de la ronda, doblado con tus tomas.'],
  'Detection des locuteurs': ['Speaker detection', 'Deteccion de locutores'],
  'Repartit les clips entre les voix de la source, pour remplir la colonne Personnage sans tout saisir a la main.':
    ['Sorts the clips by voice, to fill the Character column without typing it all.',
      'Reparte los clips entre las voces de la fuente, para rellenar la columna Personaje sin escribirlo todo.'],
  'Detecter les locuteurs': ['Detect speakers', 'Detectar locutores'],
  'Ecraser les personnages deja attribues': ['Overwrite characters already assigned', 'Sobrescribir los personajes ya asignados'],
  'pyannote.audio non installe — voir Reglages': ['pyannote.audio not installed — see Settings', 'pyannote.audio no instalado — ver Ajustes'],
  ...
  'La bande son sans les voix, jouee pendant que tu doubles. Demucs la fabrique depuis la source.':
    ['The soundtrack without the voices, played while you dub. Demucs makes it from the source.',
      'La banda sonora sin las voces, sonando mientras doblas. Demucs la fabrica desde la fuente.'],
  'Separer les voix de la musique': ['Split voices from music', 'Separar las voces de la musica'],
  'Separation des voix': ['Separating the voices', 'Separando las voces'],
  'demucs non installe — voir Reglages': ['demucs not installed — see Settings', 'demucs no instalado — ver Ajustes'],
  'Piste d\'ambiance prete.': ['Backing track ready.', 'Pista de ambiente lista.'],
  'Piste d\'ambiance (demucs)': ['Backing track (demucs)', 'Pista de ambiente (demucs)'],
  'Separe les voix de la musique pour fabriquer': ['Splits voices from music to build', 'Separa las voces de la musica para fabricar'],
  'automatiquement. Tire PyTorch avec lui : compter plusieurs Go.':
    ['automatically. It pulls PyTorch along: expect several GB.',
      'automaticamente. Arrastra PyTorch consigo: cuenta varios GB.'],
  'Personnages (rembg, OpenCV)': ['Characters (rembg, OpenCV)', 'Personajes (rembg, OpenCV)'],
  'rembg detoure un juge ou le candidat, OpenCV va chercher dans une video l\'image ou le visage est le plus net.':
    ['rembg cuts out a judge or the contestant, OpenCV finds the frame where the face is clearest.',
      'rembg recorta a un juez o al concursante, OpenCV busca en un video el fotograma donde mejor se ve la cara.'],
  'Detection des locuteurs (pyannote)': ['Speaker detection (pyannote)', 'Deteccion de locutores (pyannote)'],
  'Le modele est sous conditions. Accepte-les sur les deux pages —':
    ['The model is gated. Accept its terms on both pages —',
      'El modelo tiene condiciones. Aceptalas en las dos paginas:'],
  'et': ['and', 'y'],
  ...
  'Attribution des personnages': ['Assigning the characters', 'Asignando los personajes'],
  'Chargement du modele': ['Loading the model', 'Cargando el modelo'],
  'Detourage du personnage': ['Cutting the character out', 'Recortando al personaje'],
  'Recherche d\'un visage': ['Looking for a face', 'Buscando una cara'],
  'Personnage detoure': ['Character cut out', 'Personaje recortado'],
  'Image prete': ['Image ready', 'Imagen lista'],
  'Detourage': ['Cutting out', 'Recorte'],
  'Image depuis une video': ['Still from a video', 'Imagen desde un video'],
