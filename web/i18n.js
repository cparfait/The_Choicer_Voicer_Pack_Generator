...
const DICT = {
  ...
  'Le modele est sous conditions : accepte-les sur': ['The model is gated: accept its terms on', 'El modelo tiene condiciones: aceptalas en'],
  ', puis colle ici un jeton d\'acces.': [', then paste an access token here.', ', y luego pega aqui un token de acceso.'],
